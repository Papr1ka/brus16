...
add_file -type verilog "src/tn20k/gowin_clkdiv/gowin_clkdiv.v"
add_file -type verilog "src/tn20k/gowin_rpll/gowin_rpll.v"
add_file -type cst "src/tn20k/20k.cst"
add_file -type sdc "src/tn20k/20k.sdc"
...
set_option -output_base_name tn20k
